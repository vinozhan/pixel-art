  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Discover unique hand-drawn artworks that capture emotions,
              memories, and moments. Commission your own personalized
              masterpiece.
            </Motion.p>
          ...
          >
            <div className="relative">
              ...
              <Motion.div
                ...
                className="absolute -inset-4 bg-linear-to-br from-[#C4A77D]/20 to-[#A89F91]/20 rounded-3xl"
              />
      ...
      >
        ...
        >
          <span className="text-xs font-medium mb-2 tracking-wider">
            SCROLL
          </span>
          <HiArrowDown size={20} />
        </Motion.button>
